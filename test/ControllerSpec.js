...
describe('controller', function () {
	...
	it('should highlight "All" filter by default', function () {
		// TODO: write test
		var todo = [{title: 'my todo 1', completed: false}, {title: 'my todo 2', completed: true}];
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo = [{id: 1, title: 'my todo 1', completed: false}, {id: 2, title: 'my todo 2', completed: false}];
